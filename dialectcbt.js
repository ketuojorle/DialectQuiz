     ...
     "<b>Note:You can't go back to previous question(s)</b><br >" +
          ...
          let  Questions= [["Ebu is in which Local Government Area of Delta State?","Oshimili South","Aniocha North","Oshimili North","C"],
                       ...
                       ["What is <span class='skyblue'>ogwu mu-eji</span> mayu <span class='skyblue'>ela</span>","29","209","49","C"],
                       [" <span class='skyblue'>Ogwu mu-elu</span> is what?","25","100","205","B"],
                       ["Which of these towns is not an immediate neighbour to Ebu","Onicha-olona","Illah","Iyelen","A"],
                       ["Evaluate <big>5</big><small>(1/5)</small> + <span class='skyblue'>Elu</span> ","15","10","6","C"],
                       ...
                       ["Orderly name these in Ebu dialect <small>first, second, third, fourth, fifth</small>","onka, eji, eta, ele,   elu","ekinye,ekeji, eketa, ekele, ekelu","eyonka, eyomeji, eyometa, eyomele, eyomelu","B"],
                       ["What is the synonym of <span class='skyblue'>ku mai deh?</span>","ku weh chei?","ku chu odu eleh?","ku weh jeh","B"],
                       ["<span class='skyblue'>You</span>(2nd person singular pronoun) is called ----- in Ebu","awa","uwe","ama","B"],                        
                       ["<span class='skyblue'>You</span>(2nd person plural pronoun) is called ----- in Ebu","eme","ama","awa","A"],     
                       ["<span class='skyblue'>We</span>(1st  person plural pronoun(subject)) is called ----- in Ebu","ama","awa","eme","B"],
   ...
   function checkAnswer(){
       ...
       if(m < 0 && q < QLen){
                  ...
                  questionContainer.innerHTML="<h4><b style='color:red;transform:translate(0px, 110px);'>OOOooops!</b><br>TIME OVER</h4><h1>Thanks for taking the Test</h1>" ;
